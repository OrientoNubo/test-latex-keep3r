...
\begin{figure*}[t]
    ...
    \begin{tikzpicture}[
        ...
        \node[bb] (dec)   at (5.5,0) {Causal streaming\\decoder (frozen)};
        ...
        \node[box, minimum width=7.0cm] (mgr) at (10.15,-2.08) {};
        \node[lbl, anchor=north] at ([yshift=-3.5pt]mgr.north)
            {\textit{budgeted cache management (training-free)}};
        \node[chip] (c1) at (7.42,-2.42)  {CFAS $r$};
        \node[chip] (c2) at (8.68,-2.42)  {SCR $s$};
        \node[chip] (c3) at (9.92,-2.42)  {TSA $a$};
        \node[chip] (c4) at (11.42,-2.42) {hybrid $h(\beta,d)$};
        \node[chip] (c5) at (12.98,-2.42) {top-$k$};
        \draw[->, vizviolet!70, line width=0.6pt] (c1) -- (c2);
        \draw[->, vizviolet!70, line width=0.6pt] (c2) -- (c3);
        \draw[->, vizviolet!70, line width=0.6pt] (c3) -- (c4);
        \draw[->, vizviolet!70, line width=0.6pt] (c4) -- (c5);
